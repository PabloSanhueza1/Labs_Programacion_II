package ejercicio43lab4;

import java.util.ArrayList;

public class Ejercicio43Lab4 {

    public static void main(String[] args) {

        Expendedor expendedor = new Expendedor(100000);
        for (int i = 0; i < 100000; i++) {
            Moneda moneda = new Moneda();
            Bebida bebida = expendedor.comprarBebida(moneda, 1);
...
class Expendedor {
    ...
    public Expendedor(int cantidad) {
        ...
        for (int i = 0; i < cantidad; i++) {
            ...
            Bebida sprai = new Sprite(200 + i);
            sprite.addBebida(sprai);
        }
    }
